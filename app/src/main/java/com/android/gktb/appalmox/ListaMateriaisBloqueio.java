 ...
 */
public class ListaMateriaisBloqueio extends Activity {
    ...
    protected void onCreate(Bundle icicle){
        ...
        setContentView(R.layout.layout_bloq_lista);
        ...
        Button btnVoltar = (Button) findViewById(R.id.btnSairListaBloq);
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ListaMateriaisBloqueio.this, telaMenu.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void ObtemListaMateriais(){
        ...
        AsyncTask<String, String, JSONObject> task = new AsyncTask<String, String, JSONObject>() {
            ...
            protected void onPreExecute(){
                dialog = new ProgressDialog(ListaMateriaisBloqueio.this);
            ...
            protected void onPostExecute(JSONObject json){
                ...
                try {
                    ...
                    for (int i = 0; i < materiais.length(); i++) {
                        ...
                        lista = (ListView) findViewById(R.id.listagemMatBloq);
                        BaseAdapter adapter = new SimpleAdapter(ListaMateriaisBloqueio.this, oslist, R.layout.lista_materiais_custom,
